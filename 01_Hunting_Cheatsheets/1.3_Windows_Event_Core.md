...
* **Priority:** P0: Critical (Execution / Defense Evasion / Initial Access)
...
* **Adversary Intent 1: Initial Access — MotW Provenance Tracking (TA0001)**
    ...
    - **Detection Logic:**
        ...
        - **Reverse Alert (MotW Bypass):** Monitor for the creation of executable extensions (`.exe`, `.dll`, `.lnk`, `.iso`, `.js`, `.hta`) without a corresponding `:Zone.Identifier` creation within a 60-second window. This strongly indicates containerized delivery (e.g., malicious ISO/ZIP extracting files without MotW propagation).
