...
* **Adversary Intent 1: Initial Access — MotW Provenance Tracking (TA0001)**
    - **Mechanism:** Tracking Mark of the Web (MotW) application to files originating from the internet or other zones (T1553.005).
    - **Key Fields to Analyze:**
    ...
    - **Reference:** [8.1.18_NTFS_and_File_System_Internals.md]
...
* **Adversary Intent 3: Defense Evasion — SYSVOL/GPO Tampering (TA0005)**
    ...
    - **Reference:** [8.2.08 GPO Delegation and Abuse Logic]
