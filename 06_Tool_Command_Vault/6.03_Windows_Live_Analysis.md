...
## File Metadata & Alternate Data Streams (ADS)

*Goal: Identify Mark of the Web (MotW) and ascertain the true origin of a downloaded file.*

### Extract Zone.Identifier (MotW)

*Files downloaded from the Internet Zone are tagged with ZoneId=3. This stream often reveals the source URL.*

**List all files with a Zone.Identifier stream:**
